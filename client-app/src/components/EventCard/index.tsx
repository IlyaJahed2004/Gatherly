    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          {/* استفاده از کامپوننت Button پروژه و اورراید کردن استایل‌های بزرگ آن */}
          <Button className="!w-auto !h-auto !py-2 !px-4 !text-sm !rounded-lg !bg-gray-900 hover:!bg-gray-800 !border-none !shadow-none">
            View
          </Button>
        </div>
      </div>
