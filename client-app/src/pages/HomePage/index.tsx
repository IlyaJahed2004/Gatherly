...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-[#F3F4F6] py-10 px-6 lg:px-10">
      {/* اضافه کردن items-start به گرید اصلی برای جلوگیری از استرچ شدن المان‌ها */}
      <div className="max-w-[95%] mx-auto grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
        ...
        {/* حذف h-full تا محتوا به اندازه واقعی خودش ارتفاع بگیرد */}
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-[#FFFFFF] rounded-3xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="py-2 px-4 rounded-full bg-[#14B8A6] text-[#FFFFFF] text-[20px] font-medium shadow-sm">Leisure</button>
