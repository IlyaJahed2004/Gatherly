...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-[#F3F4F6] py-10 px-6 lg:px-10">
      {/* گرید اصلی - پیش‌فرض items-stretch است که باعث هم‌قد شدن دو ستون اصلی می‌شود */}
      <div className="max-w-[95%] mx-auto grid grid-cols-1 xl:grid-cols-3 gap-8">
        
        {/* ستون چپ: اضافه شدن h-full باعث می‌شود کارت‌ها به اندازه ستون راست کش بیایند */}
        ...
        <div className="flex flex-col gap-8 h-full">
          ...
          {/* Event Type Widget - کلاس shrink-0 باعث می‌شود فشرده نشود */}
          <div className="bg-[#FFFFFF] rounded-[16px] p-[32px] shrink-0" style={{ boxShadow: '4px 4px 8px 0 rgba(0,0,0,0.25)' }}>
          ...
          {/* Calendar Widget Container - کلاس flex-grow برای پر کردن باقی‌مانده ارتفاع */}
          <div className="rounded-[16px] flex-grow flex flex-col" style={{ boxShadow: '4px 4px 8px 0 rgba(0,0,0,0.25)' }}>
            <CalendarWidget />
          </div>
